<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="./">Ask God</a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-id-badge"></i><a href="/god/addLord">Add</a></li>
                        <li><i class="fa fa-exclamation-triangle"></i><a href="/god/lords">Delete</a></li>
                    </ul>
                </li>

                <h3 class="menu-title">Questions</h3><!-- /.menu-title -->
                ...
                <li class="active">
                    <a href="/god/logout"> <i class="menu-icon fa fa-sign-in"></i>Log Out </a>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </nav>
