            ...
            <div class="col-sm-6 col-md-4 col-lg-3" style="margin: 10px;">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            <a href="/user/complaint/{{$complaint->slug}}" class="btn btn-common" role="button">See Problem</a>
                            <a href="/user/complaint/report/{{$complaint->id}}" class="btn btn-common" role="button">Report</a>
                        </p>
                    </div>
                </div>
            </div>
